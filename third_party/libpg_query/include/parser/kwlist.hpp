...
PG_KEYWORD("api", API, RESERVED_KEYWORD)
...
PG_KEYWORD("edges", EDGES, UNRESERVED_KEYWORD)
...
PG_KEYWORD("features", FEATURES, RESERVED_KEYWORD)
...
PG_KEYWORD("gnn", GNN, RESERVED_KEYWORD)
...
PG_KEYWORD("llm", LLM, RESERVED_KEYWORD)
PG_KEYWORD("lm", LM, RESERVED_KEYWORD)
...
PG_KEYWORD("nodes", NODES, UNRESERVED_KEYWORD)
...
PG_KEYWORD("output", OUTPUT, UNRESERVED_KEYWORD)
...
PG_KEYWORD("prompt", PROMPT, RESERVED_KEYWORD)
...
PG_KEYWORD("tabular", TABULAR, RESERVED_KEYWORD)
PG_KEYWORD("takes", TAKES, UNRESERVED_KEYWORD)
