...
private:
	...
	//! Transform a Postgres duckdb_libpgquery::T_PGAlterModelStmt node into AlterStatement
	unique_ptr<AlterStatement> TransformAlterModel(duckdb_libpgquery::PGAlterModelStmt &stmt);
