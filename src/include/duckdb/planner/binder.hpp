...
private:
	...
	unique_ptr<BoundTableRef> Bind(TablePredictRef &expr);

	unique_ptr<BoundTableRef> BindBoundPredict(TablePredictRef &expr);
	...
	unique_ptr<LogicalOperator> CreatePlan(BoundPredictRef &ref);
